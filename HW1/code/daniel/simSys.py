from daniel.my_ctl import *
from daniel.my_taskSpace_ctl import *
    ...
    for k in range(len(ctls)):
        for i in range((nSteps - 1)):
            ...
            if not target['cartCtl']:
                # Added k*nsteps as starting index for q_hist. Otherwise the history of the controller before is also passed
